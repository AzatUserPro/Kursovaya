...
task = st.sidebar.radio("Цель анализа:", [
    ...
    "3. Факторы, влияющие на баллы абитурентов",
    "4. Сравнение вузов по ключевым показателям",
    "5. Подбор вуза по вашим критериям",
    "6. Кластеризация вузов",
    "7. Подбор вуза по вашим баллам ЕГЭ"])
...
# === ЗАДАЧА 3: ФАКТОРЫ ВЛИЯНИЯ ===
elif task == "3. Факторы, влияющие на баллы абитурентов":
...
# === ЗАДАЧА 4: СРАВНЕНИЕ ВУЗОВ ===
elif task == "4. Сравнение вузов по ключевым показателям":
...
# === ЗАДАЧА 5: РЕКОМЕНДАЦИИ ДЛЯ АБИТУРИЕНТА ===
elif task == "5. Подбор вуза по вашим критериям":
...
# === ЗАДАЧА 6: КЛАСТЕРИЗАЦИЯ ВУЗОВ ===
elif task == "6. Кластеризация вузов":
...
# === ЗАДАЧА 7: ПОДБОР ВУЗА ПО БАЛЛАМ ЕГЭ ===
elif task == "7. Подбор вуза по вашим баллам ЕГЭ":
